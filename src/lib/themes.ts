...
export const THEMES: ReadonlyArray<ThemeMeta> = [
  {
    id: "violet",
    name: "Violeta",
    tagline: "O padrão: marcante e levemente descontraído.",
  ...
  },
  {
    id: "cobalt",
    name: "Cobalto",
    tagline: "Azul limpo e profissional, com aparência tranquila.",
    swatch: "oklch(0.585 0.2 254)",
  },
  {
    id: "amber",
    name: "Âmbar",
    tagline: "Acolhedor e amigável, ideal para equipes pequenas.",
    swatch: "oklch(0.745 0.16 65)",
  },
  {
    id: "rose",
    name: "Rosa",
    tagline: "Marcante e moderno para marcas e negócios criativos.",
