    ...
    <div className="flex h-[60vh] min-h-[420px] flex-col rounded-xl border border-border bg-card">
      ...
      <div className="flex items-center justify-between border-b border-border px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-foreground">Ambiente de testes</span>
          <span className="text-xs text-muted-foreground">
            — teste as respostas como se fosse um cliente
          </span>
        </div>
        <Button
          variant="ghost"
        ...
        {turns.length === 0 && (
          <div className="flex h-full flex-col items-center justify-center text-center text-sm text-muted-foreground">
            ...
            <p className="mt-1 text-xs">
              Ele usa sua base de conhecimento e se comporta como o bot de
              resposta automática, inclusive ao transferir o atendimento.
            </p>
            {onGoToSetup && (
              <Button
                variant="link"
            ...
            >
              ...
              {t.role === 'assistant' && t.handoff && (
                ...
                >
                  ...
                  Transferiria para uma pessoa neste ponto
                </p>
              )}
            </div>
            {t.role === 'user' && (
