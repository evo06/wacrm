  ...
  return (
    <div>
      <SettingsPanelHead
        ...
        description="Textos e mensagens interativas reutilizáveis que os agentes podem inserir na caixa de entrada."
        action={
      ...
      {loading ? (
        ...
        <p className="rounded-lg border border-dashed border-border py-10 text-center text-sm text-muted-foreground">
          Ainda não há respostas rápidas. Crie uma para reutilizá-la nas conversas.
        </p>
      ) : (
